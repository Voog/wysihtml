...
wysihtml5x is an extended and less strict approach on xing/wysihtml5 pen source rich text editor based on HTML5 technology.
...
* Improved parses with options to: unwrap tag instead of remove, keep defined styles, complex object type definitions for allowing elements.
