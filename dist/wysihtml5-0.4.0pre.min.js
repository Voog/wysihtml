...
b);break}catch(k){}a.setEndPoint("EndToEnd",f);a.select()}},getText:function(){var a=this.getSelection();return a?a.toString():""},getNodes:function(a,b){var c=this.getRange();return c?c.getNodes([a],b):[]},fixRangeOverflow:function(a){if(this.contain){var b=rangy.createRange(this.doc);b.selectNodeContents(this.contain);a=a&&a.intersection?a.intersection(b):null}return a},getRange:function(){var a=this.getSelection(),a=a&&a.rangeCount&&a.getRangeAt(0);return a=this.fixRangeOverflow(a)},getSelection:function(){return rangy.getSelection(this.doc.defaultView||
